...
// 2. Configuring the software for awgn output
...
void scpi_vsg_awgn()
{
    ...
    // Configure freq/ampl
    viPrintf(inst, "FREQ 2.4GHz\n");
    viPrintf(inst, "POW 0.0\n");

    // Configure modulation
    viPrintf(inst, "RADIO:AWGN ON\n");
    viPrintf(inst, "RADIO:AWGN:BWIDTH 20MHz\n");
    viPrintf(inst, "RADIO:AWGN:LENGTH 1ms\n");
    viPrintf(inst, "RADIO:AWGN:SEED 123\n");
