...
The bb_api.cs source file contains the bb_api class, which acts as an interface to the BB API.
The methods provided in the bb_api class have one-to-one mappings to the C functions provided by our C++ header file.
...
The bb_example.cs source file contains a method which exercises the bb_api class.
...
"An unhandled exception of type 'System.BadImageFormatException' occurred in csharp_bb_api.exe"
