The sm_api.cs source file contains the sm_api class, which acts as an interface to the SM API.
The methods provided in the sm_api class have one-to-one mappings to the C functions provided by our C++ header file.
...
The sm_example.cs source file contains a method which exercises the sm_api class.
...
"An unhandled exception of type 'System.BadImageFormatException' occurred in csharp_sm_api.exe"
